...
tsv_file = os.path.join(WORKSPACE_ROOT, "data", "intermediate", "bard1_variants.tsv")
...
output_file = os.path.join(WORKSPACE_ROOT, "data", "intermediate", "bard1_domain_features.csv")
df_domain.to_csv(output_file, index=False)
print(f"Saved domain features to {output_file}")