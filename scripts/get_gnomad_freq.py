...
if __name__ == "__main__":
    ...
    # Read variants
    variants_file = os.path.join(WORKSPACE_ROOT, "data", "raw", "variants_for_gnomad.txt")
    ...
    # Write CSV
    output_file = os.path.join(WORKSPACE_ROOT, "data", "intermediate", "gnomad_frequencies.csv")
